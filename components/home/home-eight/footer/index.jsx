					...
					<div className="row">
						<div className="col-xl-4 col-md-12">
							<div className="sofax-footer-wrap mr-25">
								...
								<p>
									Wir setzen uns für eine digitale Welt ohne Barrieren ein und schaffen 
									Webseiten, die für alle Nutzer zugänglich sind - gemäß WCAG 2.1 und BITV.
								</p>
								<div className="sofax-social-icon">
									<ul>
										<li>
											<a target="_blank" href="https://www.twitter.com/" aria-label="Twitter">
						...
						<div className="col-xl-2 col-md-4">
							<div className="sofax-footer-menu">
								...
								<ul>
									<li>
										<Link href="/accessibility-statement">Barrierefreiheit</Link>
									</li>
									<li>
										<Link href="/wcag">WCAG Standards</Link>
									</li>
									<li>
										<Link href="/error-page">404 Seite</Link>
									</li>
									<li>
