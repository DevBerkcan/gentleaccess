          ...
          <div className="row">
            <div className="col-xl-4 col-md-12">
              <div className="sofax-footer-wrap mr-25">
                <Link href="/home">
                  <h5 className="mb-4">Genntle Access</h5>
                </Link>
                <p>
                  Wir setzen uns für eine digitale Welt ohne Barrieren ein und
                  schaffen Webseiten, die für alle Nutzer zugänglich sind -
                  gemäß WCAG 2.1 und BITV.
                </p>
